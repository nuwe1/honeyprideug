				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/setting_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
		...
		?>
								<div class="form-body form">
												...
												<div class="form-group">
													<label class="col-md-2 control-label">Start timeout:</label>
													<div class="col-md-4">
														<input type="text" class="form-control" value="<?=$times['starting_timeout']?>"  required="required" name="timeone">
														<span class="help-block">
														Add the timeout in minutes. </span>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-2 control-label">Home timeout:</label>
													<div class="col-md-4">
														<input type="text" class="form-control" value="<?=$times['homepage_timeout']?>" required="required" name="timetwo">
														<span class="help-block">
														Add the timeout in minutes. </span>
													</div>
												</div>
