				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Edit success story
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/sucessstoryedit_submition/'.$id); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
		...
		?>
								<div class="form-body form">
									<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" value="<?=$story['name'];?>" required="required" name="name">
                                           ...
                                           <div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" value="<?=$story['title'];?>" required="required" name="title">
														<span class="help-block">
												...
												<div class="form-group">
													...
													<div class="col-md-10">
														<textarea class="form-control"  id="summernote_1"   name="content"   rows="6"  ><?=$story['content'];?></textarea>
														<span class="help-block">
