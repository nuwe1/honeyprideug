				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-photo"></i> Add a Service
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/services_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
								...
								<div class="form-body form">
												 ...
												 <div class="form-group">
													...
													<div class="col-md-4">
														...
														What is the name of the service. </span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control"  required="required" name="caption">
														<span class="help-block">
														What is the caption of the image. </span>
													</div>
												</div>
