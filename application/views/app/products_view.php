				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-file-video-o"></i>Products
							</div>
							<div class="tools">
							...
							<thead >
                                    ...
                                    if( !empty($products) ) {
                                      foreach ($products as $product) {
                                        ...
                                        <td>'.$product['name'].'</td>
                                        <td class="center"><img src="'.base_url().'assets/images/products/'.$product['image'].'" alt="no image" class="thumbnail"height="75em" width="75em">'.
                                        '</td>
                                        ...
                                        <td>
                                         <span class="btn-group">
                                            ...
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_product/'.$product["product_id"]).'">Remove</a></span>
                                          </span>
                                         </td>
                                        </tr>';
