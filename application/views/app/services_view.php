				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-file-video-o"></i>Services
							</div>
							<div class="tools">
							...
							<thead >
                                    ...
                                    if( !empty($services) ) {
                                      foreach ($services as $service) {
                                        ...
                                        <td>'.$service['name'].'</td>
                                        <td class="center"><img src="'.base_url().'assets/images/services/'.$service['image'].'" alt="no image" class="thumbnail"height="75em" width="75em">'.
                                        '</td>
                                        <td>'.$service['caption'].'</td>
                                        <td>'.$service['dateadded'].'</td>
                                        <td>'.$service['admin_fullname'].'</td>
                                        <td>
                                         <span class="btn-group">
                                            
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_services/'.$service["service_id"]).'">Remove</a></span>
                                          </span>
                                         </td>
                                        </tr>';
