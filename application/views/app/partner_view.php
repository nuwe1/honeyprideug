							...
							<thead >
                                    ...
                                    if( !empty($partners) ) {
                                      foreach ($partners as $partner) {
                                        ...
                                        <td>'.$partner['name'].'</td>
                                        <td class="center"><img src="'.base_url().'assets/images/partners/'.$partner['logo'].'" alt="no image" class="thumbnail"height="75em" width="75em">'.
                                        '</td>
                                        ...
                                        <span class="btn-group">
                                            ...
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_partner/'.$partner["id"]).'">Remove</a></span>
                                          </span>
                                         </td>
                                        </tr>';
