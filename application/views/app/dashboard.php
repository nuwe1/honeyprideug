    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Dashboard <small>statistics & reports</small></h1> </div>
            <!-- END PAGE TITLE -->
        </div>
        <!-- END PAGE HEAD -->
        ...
        <div class="row margin-top-10">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp"><?=$about['aboutotal'];?><small class="font-green-sharp"></small></h3> <small>ABOUT</small> </div>
                        <div class="icon"> <i class="fa fa-info-circle"></i> </div>
                    </div>
                    <div class="progress-info">
                        <div class="progress"> <span style="width: 76%;" class="progress-bar progress-bar-success green-sharp">
								<span class="sr-only">76% page visits</span> </span>
                        </div>
                        <div class="status">
                            <div class="status-title"> page visits </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp"><?=$main['maintotal'];?><small class="font-green-sharp"></small></h3> <small>MAINTENANCE</small> </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp"><?=$family['famtotal'];?><small class="font-green-sharp"></small></h3> <small>FAMILY</small> </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp"><?=$property['proptotal'];?><small class="font-green-sharp"></small></h3> <small>PROPERTY</small> </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp"><?=$gbv['gbvtotal'];?><small class="font-green-sharp"></small></h3> <small>GBV</small> </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-red-haze"><?=$referals['reftotal'];?></h3> <small>REFERALS</small> </div>
                        <div class="icon"> <i class="fa fa-share-square-o"></i> </div>
                    </div>
                    <div class="progress-info">
                        <div class="progress"> <span style="width: 85%;" class="progress-bar progress-bar-success red-haze">
								<span class="sr-only">85% page visits</span> </span>
                        </div>
                        <div class="status">
                            <div class="status-title"> page visits </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-blue-sharp"><?=$court['courtotal'];?></h3> <small>COURT PROCESSES</small> </div>
                        <div class="icon"> <i class="fa fa-gavel"></i> </div>
                    </div>
                    <div class="progress-info">
                        <div class="progress"> <span style="width: 45%;" class="progress-bar progress-bar-success blue-sharp">
								<span class="sr-only">45% page visits</span> </span>
                        </div>
                        <div class="status">
                            <div class="status-title"> page visits </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-purple-soft"><?=$sucess['storytotal'];?></h3> <small>SUCESS STORIES</small> </div>
                        <div class="icon"> <i class="fa fa-check-circle"></i> </div>
                    </div>
                    <div class="progress-info">
                        <div class="progress"> <span style="width: 57%;" class="progress-bar progress-bar-success purple-soft">
								<span class="sr-only">56% page visits</span> </span>
                        </div>
                        <div class="status">
                            <div class="status-title"> page visits </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption caption-md"> <i class="icon-bar-chart theme-font-color hide"></i> <span class="caption-subject theme-font-color bold uppercase">Site Statistics</span> <span class="caption-helper hide">weekly stats...</span> </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        <div class="row list-separated">
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="font-grey-mint font-sm"> Below 18 </div>
                                <div class="uppercase font-hg font-red-flamingo"><?=$first['one'];?> <span class="font-lg font-grey-mint"></span> </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="font-grey-mint font-sm"> 19 - 34</div>
                                <div class="uppercase font-hg theme-font-color"> <?=$second['two'];?> <span class="font-lg font-grey-mint"></span> </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="font-grey-mint font-sm"> 35 - 50 </div>
                                <div class="uppercase font-hg font-purple"><?=$third['three'];?> <span class="font-lg font-grey-mint"></span> </div>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="font-grey-mint font-sm"> Above 50 </div>
                                <div class="uppercase font-hg font-blue-sharp"> <?=$fourth['four'];?> <span class="font-lg font-grey-mint"></span> </div>
                            </div>
                        </div>
                        <ul class="list-separated list-inline-xs hide">
                            <li>
                                <div class="font-grey-mint font-sm"> Total Visits </div>
                                <div class="uppercase font-hg font-red-flamingo"> 13,760 <span class="font-lg font-grey-mint"></span> </div>
                            </li>
                            <li> </li>
                            <li class="border">
                                <div class="font-grey-mint font-sm"> Below 18 </div>
                                <div class="uppercase font-hg theme-font-color"> 4,760 <span class="font-lg font-grey-mint"></span> </div>
                            </li>
                            <li class="divider"> </li>
                            <li>
                                <div class="font-grey-mint font-sm"> 19 - 50 </div>
                                <div class="uppercase font-hg font-purple"> 11,760 <span class="font-lg font-grey-mint"></span> </div>
                            </li>
                            <li class="divider"> </li>
                            <li>
                                <div class="font-grey-mint font-sm"> Above 50 </div>
                                <div class="uppercase font-hg font-blue-sharp"> 9,760 <span class="font-lg font-grey-mint"></span> </div>
                            </li>
                        </ul>
            ...
            <div class="col-md-6">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-bar-chart font-green-haze"></i> <span class="caption-subject bold uppercase font-green-haze">Pie Chart</span> <span class="caption-helper">page statistics</span> </div>
                        <div class="tools">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-bar-chart font-green-haze"></i> <span class="caption-subject bold uppercase font-green-haze"> Statistics</span> <span class="caption-helper">with stock events</span> </div>
                        <div class="tools">
                            <a href="javascript:;" class="collapse"> </a>
                            <a href="#portlet-config" data-toggle="modal" class="config"> </a>
                            <a href="javascript:;" class="reload"> </a>
...
<script>
    ...
    //     });
    // }
var about = <?=$about['aboutotal'];?>;
about = parseInt(about);
var main = <?=$main['maintotal'];?>;
main  = parseInt(main);
var fam = <?=$family['famtotal'];?>;
fam = parseInt(fam);
var prop = <?=$property['proptotal'];?>;
prop = parseInt(prop);
var gbv = <?=$gbv['gbvtotal'];?>;
gbv = parseInt(gbv);
var referals = <?=$referals['reftotal'];?>;
referals = parseInt(referals);
var court = <?=$court['courtotal'];?>;
court = parseInt('court');
var sucess = <?=$sucess['storytotal'];?>;
sucess = parseInt(sucess)
