				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-envelope"></i>View questions
							</div>
							<div class="tools">
							...
							<thead >
                                    ...
                                    if( !empty($feedbacks) ) {
                                      foreach ($feedbacks as $feedback) {
                                        ...
                                        <td>'.$feedback['type'].'</td>
                                        <td>'.$feedback['answers'].'</td>
                                        <td>'.$feedback['position'].'</td>
                                        <td>
                                        <span class="btn-group">
                                            <span class = "btn btn-success "><a href="'.site_url('App/delete_feedback_question/'.$feedback["id"]).'">Remove</a></span>
