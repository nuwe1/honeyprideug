				...
				<div class="col-md-12">
					...
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-desktop"></i> Edit a showtime
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/showtimeedit_submition/'.$id); ?>" class="form-horizontal form-bordered" method="post">
								<?php
		...
		?>
								<div class="form-body form">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
									 <input type="text" class="form-control" placeholder="Enter date" value="<?=$time['day'];?>" name="date">
									...
									<div class="col-md-4">
									 <input type="text" class="form-control" value="<?=$time['start'];?>" placeholder="Enter time" name="time">
									       <span class="help-block">
									       Enter the time. </span>
								            </div>
								...
								<div class="col-md-4">
									<input type="text" class="form-control" value="<?=$time['pricing'];?>" placeholder="Enter price" name="price">
									<span class="help-block">
