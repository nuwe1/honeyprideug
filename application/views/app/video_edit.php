				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class=" fa fa-video"></i> Edit News
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/videossedit_submition/'.$id); ?>" class="form-horizontal form-bordered" method="post">
								<?php
		...
		?>
								...
								<div class="form-body">
									 <div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" placeholder="Enter text" required="required" name="headline" value="<?=$news['headline'];?>">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control" name="description" id="summernote_1" rows="6"><?=$news['description'];?></textarea>
										</div>
									</div>
									 <div class="form-group">
													<label class="col-md-2 control-label">Video:</label>
													<div class="col-md-10">
														<input type="text" class="form-control" placeholder="Enter text" value="<?=$news['video_link'];?>"  required="required" name="url">
														<span class="help-block">
												 ...
												 <div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" placeholder="Enter text" value="<?=$news['author'];?>" required="required" name="author">
														<span class="help-block">
