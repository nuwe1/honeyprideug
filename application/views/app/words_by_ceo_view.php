				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class=" fa fa-newspaper-o"></i> Words of CEO
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/words_by_ceo_submition'); ?>" class="form-horizontal form-bordered" method="post">
								<?php
		...
		?>
								...
								<div class="form-group" id="init-mision">
										<label class="control-label col-md-2">Words by CEO:</label>
										<div class="col-md-10 mision">
											<textarea class="form-control"  id="summernote_1" name="en_description" rows="6"><?=$wordsbyceo['content'];?></textarea>
										</div>
									</div>
