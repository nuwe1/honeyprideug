				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i> Add a Team member
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/team_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
								...
								<div class="form-body form">
												 ...
												 <div class="form-group">
													...
													<div class="col-md-4">
														...
														What is the name of the team member. </span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control"  required="required" name="contact">
														<span class="help-block">
														What is the contact of this team member. </span>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<span class="help-block">
														What is the role of this team member. </span>
													</div>
												</div>
												<div class="form-group" id="init-mision">
										<label class="control-label col-md-2">Description:</label>
										<div class="col-md-10 mision">
											<textarea class="form-control"  id="summernote_1" name="en_description" rows="6"></textarea>
										</div>
									</div>
