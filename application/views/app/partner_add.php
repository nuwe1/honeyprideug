				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Add a partner
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/partner_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
								...
								<div class="form-body">
									<div class="form-group">
													...
													<div class="col-md-4">
														...
														What is the name of the partner. </span>
													</div>
												</div>
								<div class="form-group">
													<label class="col-md-2 control-label">Image:</label>
													<div class="col-md-4">
														<input type="file"  name="imeg" accept="image/*">
														<span class="help-block">
														Add an image. </span>
													</div>
												</div>
