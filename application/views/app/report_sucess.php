				...
				<div class="col-md-12">
					...
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Appointment Successful
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<p style="text-align: center; padding: 10em; font-weight: bold;"> Thank You! You have sucessfully reported the emergency we wil deal with it shortly</p>
