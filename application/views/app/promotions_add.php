				...
				<div class="col-md-12">
					...
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-star-half-o"></i> Add a Promotion
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/promotions_submition'); ?>" class="form-horizontal form-bordered" method="post">
								<?php
								...
								<div class="form-body form">
									<div class="form-group">
										...
										<span class="help-block">
                                           ...
                                           <div class="form-group">
													<label class="col-md-3 control-label">Promotion Name:</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" required="required" name="name">
														<span class="help-block">
														What is the promotion called. </span>
													</div>
												</div>
												
												
												<div class="form-group">
													<label class="col-md-3 control-label">Promotion Description:</label>
													<div class="col-md-4">
														<textarea id="maxlength_textarea" required="required" name="desc" class="form-control" maxlength="225" rows="2" placeholder="Enter text" ></textarea>
														<span class="help-block">
														Give a description about the promotion. </span>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">Promotion Image:</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" name="url">
														<span class="help-block">
														Add a link to the promotion image. </span>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">Themes:</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" required="required" name="themes">
														<span class="help-block">
														What is the theme of the promotion about. </span>
													</div>
												</div>
