							...
							<thead >
                                    ...
                                    if( !empty($news) ) {
                                      foreach ($news as $new) {
                                        ...
                                        <td>'.$new['image_link'].'</td>
                                        <td>'.$new['date'].'</td>
                                        <td>'.$new['author'].'</td>
                                        <td>
                                        <span class="btn-group">
                                            <span class = "btn btn-success "><a href="'.site_url('App/edit_news/'.$new["id"]).'" >Edit</a></span>
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_news/'.$new["id"]).'">Remove</a></span>
                                          </span>
                                         </td>
