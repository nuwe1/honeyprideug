							...
							<thead >
                                    ...
                                    if( !empty($teammates) ) {
                                      foreach ($teammates as $teammate) {
                                        ...
                                        <td>'.$teammate['name'].'</td>
                                        <td class="center"><img src="'.base_url().'assets/images/team/'.$teammate['image'].'" alt="no image" class="thumbnail"height="75em" width="75em">'.
                                        '</td>
                                        <td>'.$teammate['contact'].'</td>
                                        <td>'.$teammate['role'].'</td>
                                        <td>'.$teammate['dateadded'].'</td>
                                        <td>'.$teammate['admin_fullname'].'</td>
                                        <td>
                                         <span class="btn-group">
                                            
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_teammate/'.$teammate["team_id"]).'">Remove</a></span>
                                          </span>
                                         </td>
                                        </tr>';
