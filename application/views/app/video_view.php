                                    ...
                                    if( !empty($videos) ) {
                                      foreach ($videos as $video) {
                                        ...
                                        <span class="btn-group">
                                            <span class = "btn btn-success "><a href="'.site_url('App/edit_videos/'.$video["id"]).'" >Edit</a></span>
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_video/'.$video["id"]).'">Remove</a></span>
                                          </span>
                                         </td>
