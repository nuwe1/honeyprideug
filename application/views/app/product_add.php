				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-photo"></i> Add a Product
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/products_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
								...
								<div class="form-body form">
												 ...
												 <div class="form-group">
													...
													<div class="col-md-4">
														...
														What is the name of the product. </span>
													</div>
												</div>
