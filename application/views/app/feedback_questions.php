				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-envelope"></i>Add questions
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/feedback_question_submition'); ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
								<?php
								...
								<div class="form-body form">
                                           <div class="form-group">
													...
													<div class="col-md-4">
														...
														What is the question. </span>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">Position:</label>
													<div class="col-md-4">
														<input type="text" class="form-control"  required="required" name="position">
														<span class="help-block">
														What is the question. </span>
													</div>
												</div>
