				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/newsedit_submition/'.$id); ?>" class="form-horizontal form-bordered" method="post">
								<?php
								...
								<div class="form-body">
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" placeholder="Enter text" value="<?=$news['image_link'];?>"  required="required" name="url">
														<span class="help-block">
														Add a url. </span>
													</div>
												</div>
