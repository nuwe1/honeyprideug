				...
				<div class="col-md-12">
					...
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-star-half-o"></i>Promotions Available
							</div>
							<div class="tools">
							...
							<thead >
                                    ...
                                    if( !empty($promotions) ) {
                                      foreach ($promotions as $promotion) {
                                        ...
                                        <td>'.$promotion['cname'].'</td>
                                        <td>'.$promotion['pname'].'</td>
                                        <td>'.$promotion['pdesc'].'</td>
                                        <td>'.$promotion['pimage'].'</td>
                                        <td>'.$promotion['ptheme'].'</td>
                                         <td>
                                        
                                            <a href="'.site_url('App/delete_promotion/'.$promotion["pid"]).'" class = "btn btn blue ">Remove</a>
