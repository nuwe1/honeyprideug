				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-file-video-o"></i>Success stories
							</div>
							<div class="tools">
							...
							<thead >
                                    ...
                                    if( !empty($story) ) {
                                      foreach ($story as $stori) {
                                        ...
                                        <td>'.$counter.'</td>
                                        <td class="center">'.$stori['name'].'</td>
                                       
                                        <td>' .'Title: '.$stori['title'].'<br/>'.'Date: '.$stori['date_added'].'<br/>'.'</td>
                                        ...
                                        <span class="btn-group">
                                            <span class = "btn btn-success "><a href="'.site_url('App/edit_sucessstory/'.$stori["id"]).'" >Edit</a></span>
                                            <span class = "btn btn-danger "><a href="'.site_url('App/delete_sucessstory/'.$stori["id"]).'">Remove</a></span>
                                          </span>
                                         </td>
                                        </tr>';
