				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Add our dream
							</div>
							<div class="tools">
						...
						<?php
							...
							?> 
							<!-- BEGIN FORM-->
							<form action="<?= site_url('App/our_dream_submition'); ?>" class="form-horizontal form-bordered" method="post">
								<?php
		...
		?>
								...
								<div class="form-group" id="init-mision">
										<label class="control-label col-md-2">Our dream:</label>
